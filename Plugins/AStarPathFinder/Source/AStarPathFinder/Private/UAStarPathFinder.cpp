...
void UAStarPathFinder::CreatePath(const FAStarGraphNode* Start, const FAStarGraphNode* Destination, TArray<const FAStarGraphNode*>& Out_Path) const
{
...
void UAStarPathFinder::ResetGraph()
{
	Open.Reset();
